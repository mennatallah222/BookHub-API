...
namespace API.Core.Mapping.OrderMapping
{
    public class OrderProfile : Profile
    {
        ...
        public OrderProfile()
        {
            ...
            //    .ForMember(dest => dest.CustomerId, opt => opt.MapFrom(src => src.FirstOrDefault().UserId))
            //    .ForMember(dest => dest.Name, opt => opt.MapFrom(src => src.FirstOrDefault().User.FullName))
